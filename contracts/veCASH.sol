...
contract veCASH is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("Vote-Escrow Cash", "veCASH") {
        ...
        _nft = IPapilio(address(0));
        _farm1 = ILPFarm(address(0));
        _farm2 = ILPFarm(address(0));
        ...
        nftMultiplier = 500; // 5%
        maxNFT = 10;
        stakers.push(address(this)); // fill index 0 so 'stakerToIndex' mapping default is not an issue
    }
